...
class RestPhoto extends RestBase {
    ...
    private function postPhotoFor($image, $prefix, $cover, $tagEntities, $payload) {
    ...
    public function postPhotoForAccount($image, $cover, $tagEntities, $payload = null) {
        return $this->postPhotoFor($image, "/account/profile", $cover, $tagEntities, $payload);
    }

    public function postPhotoForGroup($image, $id, $cover, $tagEntities, $payload = null) {
        return $this->postPhotoFor($image, "/group/".$id."/profile", $cover, $tagEntities, $payload);
    }

    public function postPhotoForEvent($image, $id, $cover, $tagEntities, $payload = null) {
        return $this->postPhotoFor($image, "/event/".$id."/profile", $cover, $tagEntities, $payload);
    }
}